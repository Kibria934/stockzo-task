...
const ServiceCard = ({ img, headLine }) => {
  return (
    <div>
      <div class="card card-compact text-black md:w-[96] lg:h-[680px] md:w-[300px] lg:w-96 hover:bg-black rounded-tl-none rounded-bl-none border-2 hover:text-white rounded-tr-xl rounded-br-xl">
        <figure>
